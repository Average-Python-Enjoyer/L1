...
int create_array(struct GraphicsCard array[], int* size) {
    ...
    int n;
    printf("Enter number of graphics cards to add: ");
    ...
    for (int i = 0; i < n; i++) {
        ...
        printf("Enter model of graphics card %d: ", i + 1);
        ...
        printf("Enter GPU clock of graphics card %d: ", i + 1);
        ...
        printf("Enter year of graphics card %d: ", i + 1);
